...
throw new Error("Cannot find module \"@/components/SpacesList\"");
throw new Error("Cannot find module \"@/components/Space\"");
...
var router = new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
  ...
  routes: [
    ...
    {
      path: '/',
      component: __WEBPACK_IMPORTED_MODULE_2__components_SpacesList___default.a
    },
    // Space-specific learning materials
    {
      path: '/spaces/:spaceId',
      component: __WEBPACK_IMPORTED_MODULE_3__components_Space___default.a,
      props: true
    }
  ]
})
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(3);
...
const store = new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
  ...
  actions: {
    LOAD_USER: function (context) {
      __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('token')
      .then((response) => {
    ...
    LOAD_CONTENT_TYPES (context, space) {
      ...
      __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('spaces/' + space.sys.id + '/content_types')
      .then((response) => {
    ...
    LOAD_SPACE_TOKENS (context, space) {
      ...
      __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('spaces/' + space.sys.id + '/api_keys')
      .then((response) => {
        // Get full representation of the key, including CPA key ID
        var cdaKeyId = response.data.items[0].sys.id
        __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('spaces/' + space.sys.id + '/api_keys/' + cdaKeyId)
        .then((response) => {
          var cpaKeyId = response.data.preview_api_key.sys.id
          var cdaToken = response.data.accessToken
          // Finally, grab CPA token
          __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('spaces/' + space.sys.id + '/preview_api_keys/' + cpaKeyId)
          .then((response) => {
            context.commit('SET_SPACE_TOKENS', {
              cda: cdaToken,
  ...
  mutations: {
    ...
    SET_CMA_TOKEN: function (state, cmaToken) {
      ...
      __WEBPACK_IMPORTED_MODULE_2_axios___default.a.defaults.baseURL = process.env.CONTENTFUL_CMA_URL
      __WEBPACK_IMPORTED_MODULE_2_axios___default.a.defaults.headers.common['Authorization'] = 'Bearer ' + cmaToken
      __WEBPACK_IMPORTED_MODULE_2_axios___default.a.defaults.headers.common['Content-Type'] = 'application/vnd.contentful.management.v1+json'
    },
...
(function webpackMissingModule() { throw new Error("Cannot find module \"/Users/gil/project/contentful/end-to-end\""); }());
